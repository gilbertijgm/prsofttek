		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GAT",
									"targetURL": "#comsofttekacademiatkd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsofttekacademiatkd-display": {
								"semanticObject": "comsofttekacademiatkd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.softtek.academiatkd",
									"url": sap.ui.require.toUrl("com/softtek/academiatkd")
								}
							}
						}
					}
